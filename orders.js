...
class Ticket {
  ...
  let ticket1 = new Ticket(['salad', 'pizza', 'wings'], '2023-07-21 11:30', 'Customer 456');
  console.log(ticket1);
  
  ticket1.updateStatus('in progress'); 
...
let firstTicket1 = new Ticket(['pizza', 'bread', 'soda'], '7:03 PM', 575);
firstTicket1.updateStatus('cooking');