...
class Employee {
  ...
  const employee1 = new Employee('Coco', 'Monday, Wednesday, Saturday');
const employee2 = new Employee('Jordan', 'Tuesday, Thursday, Sunday');
...
const empOne = new Employee1('Jess', 'weekday mornings, weekday afternoons');

const empTwo = new Employee1('Nick', 'weekday mornings, weekday afternoons');
